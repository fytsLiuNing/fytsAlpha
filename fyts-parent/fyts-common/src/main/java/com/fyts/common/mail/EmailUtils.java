...
public class EmailUtils {
	...
	public static boolean sendEmail(String toAddress, String subject, String content) {
		return com.fyts.common.msg.EmailUtils.send(toAddress, subject, content);
	}
	...
	public static boolean sendEmail(String fromAddress, String fromPassword, String fromHostName,
		...
		return com.fyts.common.msg.EmailUtils.send(fromAddress, fromPassword, fromHostName, sslOnConnect, sslSmtpPort, toAddress, subject, content);
	}
